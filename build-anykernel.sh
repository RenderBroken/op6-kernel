...
ZIP_MOVE="${HOME}/android/source/zips/OP6-zips"
...
function make_gcc_kernel {
	export CROSS_COMPILE="${CCACHE} ${HOME}/android/source/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-"
